      ...
      <div class="da-stat-icon" style="background: rgba(69, 87, 67, 0.1); color: var(--m3-primary); width: 64px; height: 64px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
        ${tipo === 'Fertilizante' ? '<img src="npk.png" alt="" style="width: 40px; height: 40px; object-fit: contain;">' :
          ...
          <div>
            ...
            <h2 class="da-hero-title" style="margin: 0; font-size: 24px; font-family: 'Work Sans', sans-serif; color: var(--m3-on-surface); font-weight: 800;">${tipo}</h2>
          </div>
        </div>
...
<!-- 4. Dosis (with IFCAFE suggestion) -->
          ...
          <div class="da-form-actions" style="border-top: none; margin-top: 24px; padding-top: 0; display: flex; justify-content: flex-end; gap: 12px;">
            <button type="button" class="da-action-btn secondary" onclick="window.navigateTo('detalle_lote', '${loteId}')" style="padding: 12px 24px; border-radius: 12px; background: transparent; border: 1px solid var(--m3-outline); color: var(--m3-primary); font-weight: 600; font-size: 14px; cursor: pointer; font-family: 'Work Sans', sans-serif;">
              Cancelar
            </button>
